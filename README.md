...
- **STEP 2:** Create an Azure Keyvault in your Azure Staff Sub, and create a secret in it called 'tfcloud-user-token', then copy over the secret value you created from Step 1. 
